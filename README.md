...
(P.S: As advised by the Patika.dev team, `near-sdk-as` starter kit has been used as a boilerplate in this project; however, the codes in the folders => Simple & Singleton - Assembly - index.ts files have been created from scratch and as such original.The project lacks the frontend part at this stage.)
